  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => {
          // Track individual scroll progress for each timeline item
          ...
          // Transform scroll progress to a color change
          const colorTransform = useTransform(
            itemScrollYProgress,
            [0.5, 1],
            ["#f0f0f0", "#63e"] // Neutral gray to red
          );
          ...
          return (
            ...
            >
              ...
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black dark:bg-black flex items-center justify-center">
                ...
                {/* Apply the color transformation to the text */}
                <motion.h3
